...
from .views import them_baihat, get_baihat, get_baihat_by_id, get_loi_bai_hat, update_baihat, delete_baihat, \
    search_baihat, search_album, sync_lyrics, upload_audio, get_so_luong_bai_hat, thong_ke_bai_hat_view, get_bai_hat_theo_album, upload_song, review_song, get_baihat_for_album
